...
module.exports = async(conn, msg, m, setting, store) => {
    ...
    const readmore = more.repeat(4001)
		...
		const buttonsDefault = [
			...
			{ quickReplyButton: { displayText: `⏱️ Runtime`, id: `${prefix}runtime` } },
		]
		const button5 = [
		...
		switch(command) {
			...
			case prefix+'help':
			  /*conn.sendMessage(from, { audio: fs.readFileSync('audio/Assalamualaika.m4a'), mimetype: 'audio/mp4', ptt: true}, {quoted: msg})*/
				...
				/*conn.sendMessage(from, { react: { text: `👋`, key: msg.key }})*/
conn.sendMessage(from, { caption: teks, image: fs.readFileSync('media/Jojo2.jpg'), templateButtons: buttonsDefault, footer: '© XyChan Team', mentions: [sender]} )
conn.sendMessage(from, { audio: {url : `https://d.top4top.io/m_22231oj7h1.mp3`}, mimetype: 'audio/mp4', ptt: true}, {quoted: msg})
				break
...
var teks = `  
 ...
 conn.sendMessage(from, { caption: teks, image: {url: `https://i.ibb.co/CPcFJ6c/IMG-20220131-WA0504.jpg`}, templateButtons: donasibut, footer: '© XyChan Team', mentions: [sender]} )  
			    break
case prefix+'sewa':
...
*LIST DAFTAR PREMIUM*
- Rp.15.000 - PERMANENT`
			    conn.sendMessage(from, { caption: teks, location: { jpegThumbnail: fs.readFileSync('media/Jojo2.jpg') }, templateButtons: button5, footer: '© XyChan Team', mentions: [sender] })
			    break
			case prefix+'runtime':
...
case prefix+'infobot':
  case prefix+'inforobot':
    case prefix+'info':
      var caption = `*[ INFO ROBOT Someone-Md ]*
...
case prefix+'githubown':
 ...
 break
			...
			{ quickReplyButton: { displayText: `Ubah Ke Audio`, id: `${prefix}tiktokaudio ${q}` } },
				...
				reply(mess.wait)
				conn.sendMessage(from, { caption: `Succes Download Video Tiktok, Thanks For Using JOJO-BOT!`, video: {url: data.nowm}, templateButtons: tidtod, footer: '© XyChan Team', mentions: [sender]} )
			}).catch(() => reply(mess.error.api))
			limitAdd(sender, limit)
			    break
...
conn.sendMessage(from, {caption: `✅ Done ya!!!`, image: {url: hasil}}, {quoted: msg})
break
...
case prefix+'bokep':
  if (!isPremium)return reply("Perintah Ini Khusus Pengguna Premium, Upgrade Fitur Premium Ke Owner, Ketik !owner")
  reply(mess.wait)
  var bokep = JSON.parse(fs.readFileSync('./fitur/bokep.json'))
